...
const TRACKING_APP_ID = "app384_android";
const ANDROID_APP_ID = "com.jeetbzapp.app";
const APPSFLYER_DEV_KEY = "F7mWBo45JCYBWnfcqT9cve";
const AMPLITUDE_API_KEY = "5328b743f4cba9aef452c6ebc56dba72";

const CONFIG_RD_URL =
  "https://apps-cmyk.github.io/manager-config-rd/manager-config-rd.json";
const CONFIG_UP_URL =
  "https://pincode69.github.io/manager-config-up/manager-config-up.json";
    ...
    <View style={[styles.layerContainer, styles.layerLoader]}>
      <SafeAreaView style={styles.loader}>
        <View style={styles.loaderIconWrapper}>
          ...
          />
          <Image source={{ uri: "ic_launcher" }} style={styles.loaderIconFg} />
        </View>
